...
if (!apiKey || !token) {
  console.error(
    "set TYPESAFE_API_KEY and RAINDROP_TOKEN, or write ~/.config/raincheck/credentials.json",
  );
  process.exit(2);
}
...
const raw = await fetch(
  "https://api.raindrop.io/rest/v1/raindrops/0?perpage=5&page=0",
  {
...
console.log(
  "raindrop: fields on first bookmark:",
